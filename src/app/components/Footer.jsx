  ...
  return (
    <>
      <div className="bg-white h-64 flex justify-center items-center py-5 px-5 space-x-56 md:max-xl:space-x-20 mx-auto text-center">
        <div
          className={`${inter.className} flex items-center justify-center gap-1 md:max-xl:ml-10 cursor-pointer`}
        >
          <p
            className={`text-slate-400 text-[2rem] font-bold md:w-[385px] md:text-[3rem]`}
          >
      ...
      <div className="bg-white flex justify-center items-center py-5 px-5 space-x-56 md:max-xl:space-x-20 mx-auto text-center">
        <div
          className={`flex items-center justify-center gap-1 md:max-xl:ml-10 cursor-pointer`}
        >
          <p claName={`${inter.className}`}>
